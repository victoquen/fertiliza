 ...
 */
public class SondaTipo implements Serializable{
    ObjectId id;
    String nombre;
    ...
    public ObjectId save() {
        ...
        MongoCollection table = mongo.db.getCollection("sondatipo");
    ...
    public void update() {
        ...
        SondaTipo before = getSondaTipoById(this.id);

    
        MongoManager mongo = MongoManager.getInstance(); 
        mongo.db.getCollection("sondatipo").updateOne(new Document("_id", this.id), new Document("$set", new Document("nombre", this.nombre.toUpperCase())));
